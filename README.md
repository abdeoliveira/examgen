...
To do so, you need to create the file `/session/qignore` containning the questions file names (with or without the `.gnxs` extension) to ignore, separated 
