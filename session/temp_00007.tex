...
2. Na figura abaixo, um pequeno bloco de 81 g desliza para baixo em uma superfície curva sem atrito a partir de uma altura $h=12$ cm e depois adere a uma barra uniforme de massa 164 g e comprimento 80 cm. A barra gira em torno do ponto O antes de parar  momentaneamente. Determine $\theta$ em graus.\\
...
3. Um metrô percorre uma curva plana de raio 14 m a 35 km/h. Qual o ângulo, em graus, que as alças de mão penduradas no teto fazem com a vertical?\\
(a)83,5~
(b)48,4~
(c)70,5~
(d)38,0~
...
4. Um rifle, que atira balas a 462 m/s, é apontado para um alvo situado a 156 m de distância. Se o centro do alvo está na mesma altura do rifle, para que altura (\textbf{em centímetros}) acima do alvo o cano do rifle deve ser apontado para que a bala atinja o seu centro?\\
(a)85,0~
(b)44,6~
(c)71,8~
(d)20,7~
...
5. Uma part\'{i}cula de massa 5,0 kg, lan\c cada sobre um trilho retil\'{i}neo com velocidade de 3,2 m/s, est\'a sujeita a uma for\c ca $F(x) = -bx$, onde $b=1,9$ N/m e $x$ \'e o deslocamento, em m, a partir da origem. Sabendo-se que a part\'icula para em dois pontos do trilho, a saber, $+x_0$ e $-x_0$, determine $x_0$ em metros.\\
(a)1,6~
(b)2,4~
(c)5,2~
(d)6,2~
...
7. Uma pequena aranha de peso $P_a$ está pendurada na ponta de um fio de teia, no teto de um elevador. Sabendo-se que o fio suporta uma tensão máxima de $9,7P_a$, qual seria a mínima aceleração (em m/s$^2$) de subida do elevador para que o fio se partisse?\\
(a)23,6~
(b)65,0~
(c)87,0~
(d)78,9~
...
8. Considere um objeto que se move em uma dimens\~ao de acordo com a equa\c c\~ao hor\'aria $x=v_0 t e^{-t/t_0}$, onde $t$ \'e o tempo, $v_0 = 15,9$ m/s  e $t_0 = 1,1$ s. Qual \'e a dist\^ancia, em metros, que o objeto se encontra da origem quando para momentaneamente?\\
(a)6,4~
(b)7,9~
(c)12,5~
(d)4,2~
...
9. Duas partículas, de massas $m_1$ e $m_2$, são empurradas uma contra a outra, comprimindo uma mola colocada entre elas. Quando são liberadas, a mola as arremessa em sentidos opostos. A relação entre as massas das partículas é $m_2/m_1 = 5$ e a energia armazenada na mola é de 72 J. Suponha que a mola tenha massa desprezível e que toda a energia armazenada seja transferida para as partículas. Após terminada essa transferência, qual é a energia cinética \textbf{da partícula 1} em J?\\
(a)31,3~
(b)13,0~
(c)37,8~
(d)60,0~
...
10. Considere uma colis\~ao frontal el\'astica entre duas part\'{i}culas de massas $m$ e $m^{\prime}=4m$. A part\'{i}cula de massa $m$ se move inicialmente com velocidade $v$, enquanto a outra encontra-se em repouso. Qual é a fra\c c\~ao de energia cin\'etica transferida de $m$ para $m^{\prime}$ durante a colisão?\\
(a)0,84~
(b)0,99~
(c)0,38~
(d)0,14~
