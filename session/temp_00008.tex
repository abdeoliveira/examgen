...
2. Duas partículas, de massas $m_1$ e $m_2$, são empurradas uma contra a outra, comprimindo uma mola colocada entre elas. Quando são liberadas, a mola as arremessa em sentidos opostos. A relação entre as massas das partículas é $m_2/m_1 = 7$ e a energia armazenada na mola é de 73 J. Suponha que a mola tenha massa desprezível e que toda a energia armazenada seja transferida para as partículas. Após terminada essa transferência, qual é a energia cinética \textbf{da partícula 1} em J?\\
(a)27,7~
(b)8,3~
(c)63,9~
(d)21,5~
...
3. Uma pequena aranha de peso $P_a$ está pendurada na ponta de um fio de teia, no teto de um elevador. Sabendo-se que o fio suporta uma tensão máxima de $5,6P_a$, qual seria a mínima aceleração (em m/s$^2$) de subida do elevador para que o fio se partisse?\\
(a)66,6~
(b)81,0~
(c)14,1~
(d)46,0~
...
4. Um rifle, que atira balas a 441 m/s, é apontado para um alvo situado a 59 m de distância. Se o centro do alvo está na mesma altura do rifle, para que altura (\textbf{em centímetros}) acima do alvo o cano do rifle deve ser apontado para que a bala atinja o seu centro?\\
(a)97,2~
(b)21,3~
(c)80,4~
(d)8,9~
...
5. Um metrô percorre uma curva plana de raio 20 m a 30 km/h. Qual o ângulo, em graus, que as alças de mão penduradas no teto fazem com a vertical?\\
(a)71,5~
(b)47,2~
(c)64,2~
(d)57,3~
...
6. Considere uma colis\~ao frontal el\'astica entre duas part\'{i}culas de massas $m$ e $m^{\prime}=2m$. A part\'{i}cula de massa $m$ se move inicialmente com velocidade $v$, enquanto a outra encontra-se em repouso. Qual é a fra\c c\~ao de energia cin\'etica transferida de $m$ para $m^{\prime}$ durante a colisão?\\
(a)0,42~
(b)0,68~
(c)0,03~
(d)0,51~
...
7. Considere um objeto que se move em uma dimens\~ao de acordo com a equa\c c\~ao hor\'aria $x=v_0 t e^{-t/t_0}$, onde $t$ \'e o tempo, $v_0 = 11,6$ m/s  e $t_0 = 1,9$ s. Qual \'e a dist\^ancia, em metros, que o objeto se encontra da origem quando para momentaneamente?\\
(a)12,6~
(b)4,3~
(c)10,0~
(d)11,6~
...
9. Na figura abaixo, um pequeno bloco de 79 g desliza para baixo em uma superfície curva sem atrito a partir de uma altura $h=17$ cm e depois adere a uma barra uniforme de massa 181 g e comprimento 99 cm. A barra gira em torno do ponto O antes de parar  momentaneamente. Determine $\theta$ em graus.\\
...
10. Uma part\'{i}cula de massa 1,6 kg, lan\c cada sobre um trilho retil\'{i}neo com velocidade de 3,4 m/s, est\'a sujeita a uma for\c ca $F(x) = -bx$, onde $b=0,7$ N/m e $x$ \'e o deslocamento, em m, a partir da origem. Sabendo-se que a part\'icula para em dois pontos do trilho, a saber, $+x_0$ e $-x_0$, determine $x_0$ em metros.\\
(a)2,3~
(b)4,4~
(c)0,9~
(d)5,1~
