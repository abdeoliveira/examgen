...
\fancyfoot[RO,RE]{1/2022.12.29-00.58.09}
...
1. A particle of mass 7.9 kg is subject to an external force of 17.4 N. Calculate the acceleration in m/s$^2$ in a one-dimensional movement.\\
(a)2.2~
(b)7.4\\
(c)11.8~
(d)4.2\\
...
(c) The result of summing a vector and a scalar is a scalar.\\
(d) Division between vectors is defined in Mathematics.\\
(e) Vectors can not be multiplied by scalars.\\

3. Consider the rectangle triangle of the figure below and knowing $\theta=27^{\circ}$, determine $\phi$ \textbf{in rad}.\\
