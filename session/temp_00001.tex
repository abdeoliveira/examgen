...
\fancyfoot[RO,RE]{1/2022.12.28-14.44.32}
...
1. A particle of mass 5.3 kg is subject to an external force of 11.3 N. Calculate the acceleration in m/s$^2$ in a one-dimensional movement.\\
(a)2.1~
(b)4.3\\
(c)11.2~
(d)14.9\\
...
2. Consider the rectangle triangle of the figure below and knowing $\theta=14^{\circ}$, determine $\phi$ \textbf{in rad}.\\
...
(b) The result of a scalar product between vectors is a vector itself.\\
