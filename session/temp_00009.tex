...
2. Um metrô percorre uma curva plana de raio 19 m a 31 km/h. Qual o ângulo, em graus, que as alças de mão penduradas no teto fazem com a vertical?\\
(a)52,5~
(b)70,2~
(c)61,8~
(d)41,2~
...
3. Na figura abaixo, um pequeno bloco de 92 g desliza para baixo em uma superfície curva sem atrito a partir de uma altura $h=11$ cm e depois adere a uma barra uniforme de massa 192 g e comprimento 66 cm. A barra gira em torno do ponto O antes de parar  momentaneamente. Determine $\theta$ em graus.\\
...
5. Considere um objeto que se move em uma dimens\~ao de acordo com a equa\c c\~ao hor\'aria $x=v_0 t e^{-t/t_0}$, onde $t$ \'e o tempo, $v_0 = 19,0$ m/s  e $t_0 = 1,9$ s. Qual \'e a dist\^ancia, em metros, que o objeto se encontra da origem quando para momentaneamente?\\
(a)6,5~
(b)13,3~
(c)4,0~
(d)7,8~
...
6. Uma pequena aranha de peso $P_a$ está pendurada na ponta de um fio de teia, no teto de um elevador. Sabendo-se que o fio suporta uma tensão máxima de $6,3P_a$, qual seria a mínima aceleração (em m/s$^2$) de subida do elevador para que o fio se partisse?\\
(a)63,3~
(b)19,4~
(c)39,6~
(d)53,0~
...
7. Duas partículas, de massas $m_1$ e $m_2$, são empurradas uma contra a outra, comprimindo uma mola colocada entre elas. Quando são liberadas, a mola as arremessa em sentidos opostos. A relação entre as massas das partículas é $m_2/m_1 = 6$ e a energia armazenada na mola é de 67 J. Suponha que a mola tenha massa desprezível e que toda a energia armazenada seja transferida para as partículas. Após terminada essa transferência, qual é a energia cinética \textbf{da partícula 1} em J?\\
(a)57,4~
(b)12,1~
(c)31,1~
(d)48,6~
...
8. Um rifle, que atira balas a 465 m/s, é apontado para um alvo situado a 121 m de distância. Se o centro do alvo está na mesma altura do rifle, para que altura (\textbf{em centímetros}) acima do alvo o cano do rifle deve ser apontado para que a bala atinja o seu centro?\\
(a)79,8~
(b)65,0~
(c)15,5~
(d)33,9~
...
10. Uma part\'{i}cula de massa 1,4 kg, lan\c cada sobre um trilho retil\'{i}neo com velocidade de 2,9 m/s, est\'a sujeita a uma for\c ca $F(x) = -bx$, onde $b=0,7$ N/m e $x$ \'e o deslocamento, em m, a partir da origem. Sabendo-se que a part\'icula para em dois pontos do trilho, a saber, $+x_0$ e $-x_0$, determine $x_0$ em metros.\\
(a)8,8~
(b)5,1~
(c)2,0~
(d)10,5~
